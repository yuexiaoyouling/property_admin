            ...
            public void addInterceptors(InterceptorRegistry registry) {
                registry.addInterceptor(new LoginInterceptor())
                        ...
                        .excludePathPatterns("/","/admin", "/webjars/**","/static/**","/adminStatic/**","/webStatic/**","/webPage/**","/index","/userComplaint/insertInfo",
                                ...
                                , "/carPark/getDataByPage", "/house/getDataByPage", "/house/toWebBuyPage", "/carPark/toWebBuyPage", "/carPark/toWebCarParkPage",
                                "/house/toWebHousePage", "/carPark/updateInfo", "/house/soldInfo", "/comment/**", "/userComplaint/getDataByPageWeb",
